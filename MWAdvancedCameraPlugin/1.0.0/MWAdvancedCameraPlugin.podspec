Pod::Spec.new do |s|
  ...
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWAdvancedCameraPlugin/1.0.0/MWAdvancedCameraPlugin.zip' }
  s.platform              = :ios
  s.swift_version         = '5'
  ...
  s.subspec 'Core' do |cs|
    ...
    cs.framework          = 'AVKit'
    cs.dependency           'MobileWorkflow', '~> 2.0.1'
    cs.dependency           'MWCameraPlugin', '~> 0.2.0'
