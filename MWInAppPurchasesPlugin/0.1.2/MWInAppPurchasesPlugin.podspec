Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWInAppPurchasesPlugin/0.1.2/MWInAppPurchasesPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
