Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWPushNotificationsPlugin/0.1.3/MWPushNotificationsPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
