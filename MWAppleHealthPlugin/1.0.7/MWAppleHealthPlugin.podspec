Pod::Spec.new do |s|
  ...
  Health Plugin for MobileWorkflow on iOS, based on HealthKit. There is 1 step and 1 service available:
	  ...
	  - AppleHealthService: provides authorization requests, workout fetch, workout creation, quantity samples fetch  and statistics fetch based on a timeline
  DESC
  s.homepage              = 'https://www.mobileworkflow.io'
  s.license               = { :type => 'Copyright', :file => 'LICENSE' }
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
  s.source                = { :git => 'https://github.com/FutureWorkshops/MWAppleHealthPlugin-iOS.git', :tag => "#{s.version}" }
  s.platform              = :ios
  s.swift_version         = '5'
