Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWContentDisplayPlugin/1.8.2/MWContentDisplayPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
