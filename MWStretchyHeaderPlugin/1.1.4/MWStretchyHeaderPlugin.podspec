Pod::Spec.new do |s|
  ...
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWStretchyHeaderPlugin/1.1.4/MWStretchyHeaderPlugin.zip' }
  s.platform              = :ios
  s.swift_version         = '5'
