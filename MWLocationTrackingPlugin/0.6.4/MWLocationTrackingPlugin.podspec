Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWLocationTrackingPlugin/0.6.4/MWLocationTrackingPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
