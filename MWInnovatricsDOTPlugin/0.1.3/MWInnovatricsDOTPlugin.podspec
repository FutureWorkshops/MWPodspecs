Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPluginRepository-iOS/main/MWInnovatricsDOTPlugin/0.1.3/MWInnovatricsDOTPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
